      ...
      <div className="relative w-full h-full text-center overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <article className="space-y-4 mt-12 md:mt-16">
            ...
            <Link to="/">
              <button className="w-64 px-6 py-3 mt-5 bg-gradient-to-r from-purple-500 to-indigo-700 hover:from-indigo-600 hover:to-purple-800 rounded-lg text-white shadow-lg transform transition-transform duration-200 hover:scale-110 glow-button">
                Paham!
              </button>
            </Link>
          </article>
